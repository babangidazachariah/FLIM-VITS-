...
outputVariable.addTerm(Linear.create("out1mf1", engine, -0.912, 2.517, 0.061));
outputVariable.addTerm(Linear.create("out1mf2", engine, -2.153, -2.204, -4.037));
outputVariable.addTerm(Linear.create("out1mf3", engine, -0.107, -0.148, 1.920));
outputVariable.addTerm(Linear.create("out1mf4", engine, -0.088, -0.071, 1.593));
outputVariable.addTerm(Linear.create("out1mf5", engine, -0.098, -0.040, 1.361));
outputVariable.addTerm(Linear.create("out1mf6", engine, -0.068, -0.027, 1.617));
outputVariable.addTerm(Linear.create("out1mf7", engine, -1.901, -0.081, 0.185));
outputVariable.addTerm(Linear.create("out1mf8", engine, 16.651, 11.713, 6.803));
outputVariable.addTerm(Linear.create("out1mf9", engine, -4.152, -1.033, -4.755));
outputVariable.addTerm(Linear.create("out1mf10", engine, -0.123, 0.004, 0.861));
outputVariable.addTerm(Linear.create("out1mf11", engine, -0.102, 0.006, 0.816));
outputVariable.addTerm(Linear.create("out1mf12", engine, -0.089, 0.038, 0.515));
outputVariable.addTerm(Linear.create("out1mf13", engine, -0.074, 0.082, -0.061));
outputVariable.addTerm(Linear.create("out1mf14", engine, -0.009, -0.173, 4.841));
outputVariable.addTerm(Linear.create("out1mf15", engine, -7.995, -2.818, 17.910));
outputVariable.addTerm(Linear.create("out1mf16", engine, 0.674, 0.745, -2.167));
outputVariable.addTerm(Linear.create("out1mf17", engine, -0.130, -0.004, 0.869));
outputVariable.addTerm(Linear.create("out1mf18", engine, -0.094, 0.061, 0.366));
outputVariable.addTerm(Linear.create("out1mf19", engine, -0.087, 0.121, -0.395));
outputVariable.addTerm(Linear.create("out1mf20", engine, -0.061, 0.162, -1.312));
outputVariable.addTerm(Linear.create("out1mf21", engine, -0.163, 0.920, -13.253));
outputVariable.addTerm(Linear.create("out1mf22", engine, 1.417, 3.072, 1.881));
outputVariable.addTerm(Linear.create("out1mf23", engine, -0.950, -0.732, 3.128));
outputVariable.addTerm(Linear.create("out1mf24", engine, -0.058, 0.162, -0.530));
outputVariable.addTerm(Linear.create("out1mf25", engine, -0.044, 0.077, -0.121));
outputVariable.addTerm(Linear.create("out1mf26", engine, -0.061, 0.054, 0.273));
outputVariable.addTerm(Linear.create("out1mf27", engine, -0.068, 0.099, -0.250));
outputVariable.addTerm(Linear.create("out1mf28", engine, 0.429, 0.610, -9.118));
outputVariable.addTerm(Linear.create("out1mf29", engine, -6.661, -3.697, 0.015));
outputVariable.addTerm(Linear.create("out1mf30", engine, -3.544, 8.995, 0.396));
outputVariable.addTerm(Linear.create("out1mf31", engine, 0.210, -0.137, -1.010));
outputVariable.addTerm(Linear.create("out1mf32", engine, -0.003, 0.137, -1.210));
outputVariable.addTerm(Linear.create("out1mf33", engine, -0.030, 0.018, 0.107));
outputVariable.addTerm(Linear.create("out1mf34", engine, -0.227, -0.306, 6.550));
outputVariable.addTerm(Linear.create("out1mf35", engine, 11.005, -3.375, -1.135));
outputVariable.addTerm(Linear.create("out1mf36", engine, 0.578, 0.033, -0.104));
outputVariable.addTerm(Linear.create("out1mf37", engine, 0.895, -3.268, -0.992));
outputVariable.addTerm(Linear.create("out1mf38", engine, 0.125, 0.006, -1.733));
outputVariable.addTerm(Linear.create("out1mf39", engine, 0.044, 0.003, -0.303));
outputVariable.addTerm(Linear.create("out1mf40", engine, -0.179, -0.093, 3.458));
outputVariable.addTerm(Linear.create("out1mf41", engine, 0.222, 0.597, -10.102));
outputVariable.addTerm(Linear.create("out1mf42", engine, 9.320, 13.692, 0.858));
outputVariable.addTerm(Linear.create("out1mf43", engine, 0.161, -0.117, -1.382));
outputVariable.addTerm(Linear.create("out1mf44", engine, 0.495, -0.833, -6.564));
outputVariable.addTerm(Linear.create("out1mf45", engine, 0.465, -0.787, -5.610));
outputVariable.addTerm(Linear.create("out1mf46", engine, 1.334, -3.017, -2.871));
outputVariable.addTerm(Linear.create("out1mf47", engine, 2.561, -0.864, -0.557));
outputVariable.addTerm(Linear.create("out1mf48", engine, 17.123, 11.150, 1.006));
outputVariable.addTerm(Linear.create("out1mf49", engine, 0.220, 0.154, 0.010));
